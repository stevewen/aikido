#ifndef AIKIDO_PLANNER_OMPL_UTIL_NODE_STRUCTURE_HPP_
#define AIKIDO_PLANNER_OMPL_UTIL_NODE_STRUCTURE_HPP_
...
#endif // AIKIDO_PLANNER_OMPL_UTIL_NODE_STRUCTURE_HPP_
